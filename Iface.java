...
public class Iface
{
        ...
        while (option != 9)
        {
            ...
            if (option == 1)
            {
                ...
                while (logged == 1)
                {
                    ...
                    System.out.println("(2) To go to the friends menu;");
    ...
    public static void RecoverInformation()
    {
        ...
        System.out.println("(4) Your community name");
        System.out.println("(5) Your community description");
        System.out.println("(6) Your friends");
        System.out.println("(7) Your messages");
        ...
        if (option == 3)
        {
            System.out.printf("Your nickname: %s\n", nickname[WhosLogged]);
        }
        if (option == 4)
        {
